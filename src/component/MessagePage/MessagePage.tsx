            ...
            <div className="container-center">
                <div className="chat-container">
                    <div className="message-header">
                        <i className="header-icon fa fa-user-circle-o" aria-hidden="true"></i> {user?.firstName} {user?.lastName}
                    </div>
                    <div className="message-divider"></div>
                    <ul className="message-list">
                        {messages.map((messageData, id) => (
                            <li key={id} className={`message-item ${user?.firstName === messageData.sender && 'own'}`}>
                                <div className="message-bubble">
                                    <span className={`message-content ${user?.firstName === messageData.sender && 'own'}`}>
                                        {messageData.content}
                                    </span>
                                </div>
                            </li>
